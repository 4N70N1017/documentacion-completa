...
bool crearTablaTmpCaCarmovEtp( CGrabarTmpCaCarmovEtp2 &TablaTemporal, char *cSqlTxt )
{
	...
	sConsulta.Format( "CREATE TEMPORARY TABLE tmpclienteetpcacarmov ( clave char(1) DEFAULT ' '::bpchar,tipomovimiento char(1) DEFAULT ' '::bpchar,  clavelocal char(1) DEFAULT ' '::bpchar,cliente int4 DEFAULT 0,tienda int2 DEFAULT 0,ciudad int2 DEFAULT 0,caja int2 DEFAULT 0,fecha date DEFAULT timenow(),importe int4 DEFAULT 0,recibo int4 DEFAULT 0,clienteetp int4 DEFAULT 0 ) WITHOUT OIDS; " );
...
bool crearTablaTmpCaEficienciaCajeras( CGrabarTmpCaEficienciaCajeras &TablaTemporal, char *cSqlTxt )
{
	...
	sConsulta.Format( " CREATE TEMPORARY TABLE tmpcaeficienciacajeras (  tienda int2 DEFAULT 0,  fechaeficienciacajera date DEFAULT timenow(),  caja int2 DEFAULT 0,  recibo int4 DEFAULT 0,  cliente int4 DEFAULT 0,  empleado int4 DEFAULT 0,  cuentasconsaldo int4 DEFAULT 0,  cuentasconvencido int4 DEFAULT 0,  cuentasconvencidosinconvenio int4 DEFAULT 0,  cuentasconconvenio int4 DEFAULT 0 ) WITHOUT OIDS; " );
...
bool crearTablaTmpCaMovimientos( CGrabarTmpCaMovimientos &TablaTemporal, char *cSqlTxt )
{
	...
	sConsulta.Format( "CREATE TEMPORARY TABLE tmpcamovimientos(  cliente int4 DEFAULT 0,  fechaconvenio date DEFAULT timenow(),  plazoconvenio int2 DEFAULT 0,  vencido int4 DEFAULT 0,  saldofinal int4 DEFAULT 0,  fechacompra date DEFAULT timenow(),  caja int2 DEFAULT 0,  empleado int4 DEFAULT 0 ) WITHOUT OIDS; " );
...
bool crearTablaTmpCrSeguros( CGrabarTmpCrSeguros &TablaTemporal, char *cSqlTxt )
{
	...
	sConsulta.Format( " CREATE TEMPORARY TABLE tmpcrseguros(  cliente int4 DEFAULT 0,  folio int4 DEFAULT 0,  fechavencimiento date DEFAULT timenow(),  cvesinbeneficiarios int2 DEFAULT 0,cantidadseguros int2 DEFAULT 0) WITHOUT OIDS; " );
	if(memcpy_s( cSqlTxt, strnlen(cSqlTxt, size_t(cSqlTxt)), sConsulta, 255 ) < 0){;}
	cSqlTxt[ 255 ] = 0;
...
bool crearTablaTmpCrPrestamos( CGrabarTmpCrPrestamos &TablaTemporal, char *cSqlTxt )
{
	...
	sConsulta.Format( "CREATE TEMPORARY TABLE tmpcrprestamos(  cliente int4 DEFAULT 0,  tienda int2 DEFAULT 0,  factura int4 DEFAULT 0,  interesadicional int4 DEFAULT 0,  saldoactual int4 DEFAULT 0,  importeultimomovimiento int4 DEFAULT 0,  fechaultimomovimiento date DEFAULT timenow()) WITHOUT OIDS;" );
	if(memcpy_s( cSqlTxt, strnlen(cSqlTxt, size_t(cSqlTxt)), sConsulta, 255 ) < 0){;}
	cSqlTxt[ 255 ] = 0;
...
bool crearTablaTmpCrCropa( CGrabarTmpCrCropa &TablaTemporal, char *cSqlTxt )
{
	...
	sConsulta.Format( "CREATE TEMPORARY TABLE tmpcrcropa(  cliente int4 DEFAULT 0,  saldo int4 DEFAULT 0,  minimoapagar int4 DEFAULT 0,  interesadicional int4 DEFAULT 0,  fechaultimomovimiento date DEFAULT timenow(),flagactualizacion int2 DEFAULT 0 ) WITHOUT OIDS;" );
...
bool crearTablaTmpCrCmuebles( CGrabarTmpCrCmuebles &TablaTemporal, char *cSqlTxt )
{
	...
	sConsulta.Format( "CREATE TEMPORARY TABLE tmpcrcmuebles(  cliente int4 DEFAULT 0,  factura int4 DEFAULT 0,  saldo int4 DEFAULT 0,  interesadicional int4 DEFAULT 0,fechaultimomovimiento date DEFAULT timenow() ) WITHOUT OIDS;" );
	if(memcpy_s( cSqlTxt, strnlen(cSqlTxt, size_t(cSqlTxt)), sConsulta, 255 ) < 0){;}
	cSqlTxt[ 255 ] = 0;
