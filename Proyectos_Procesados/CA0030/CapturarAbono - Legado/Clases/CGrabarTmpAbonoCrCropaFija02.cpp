...
CGrabarTmpAbonoCrCropaFija02::CGrabarTmpAbonoCrCropaFija02(C_ODBC *odbc_ext, const char *select) : CRecordSet(odbc_ext)
{
    odbc = odbc_ext;
    nCols=10;
    odbcRet=TRUE;
...
CGrabarTmpAbonoCrCropaFija02::~CGrabarTmpAbonoCrCropaFija02()
{
    Commit();
}
    
void CGrabarTmpAbonoCrCropaFija02::activarCols()
{
    int i;
    for (i=0; i<nCols; i++)                                                              
    {                                                              
...
BOOL CGrabarTmpAbonoCrCropaFija02::prepararInsert()
{
BOOL retorno = FALSE;
    retorno=prepararInsert("crcropa");
    return (retorno);
}
BOOL CGrabarTmpAbonoCrCropaFija02::prepararInsert(const char *nombreTabla)
{
BOOL retorno = FALSE;
int i;
