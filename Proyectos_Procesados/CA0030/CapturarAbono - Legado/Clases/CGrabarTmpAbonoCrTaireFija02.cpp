...
CGrabarTmpAbonoCrTaireFija02::CGrabarTmpAbonoCrTaireFija02(C_ODBC *odbc_ext, const char *select) : CRecordSet(odbc_ext)
{
    odbc = odbc_ext;
    nCols=10;
    odbcRet=TRUE;
...
CGrabarTmpAbonoCrTaireFija02::~CGrabarTmpAbonoCrTaireFija02()
{
    Commit();
}
    
void CGrabarTmpAbonoCrTaireFija02::activarCols()
{
    int i;
    for (i=0; i<nCols; i++)                                                              
    {                                                              
...
BOOL CGrabarTmpAbonoCrTaireFija02::prepararInsert()
{
BOOL retorno = FALSE;
    retorno=prepararInsert("crtaire");
    return (retorno);
}
BOOL CGrabarTmpAbonoCrTaireFija02::prepararInsert(const char *nombreTabla)
{
BOOL retorno = FALSE;
int i;
