...
// Menu Seguro Club
    ...
    long checarVigenciaSeguro(int iCantidadSeguros, long lTotalMinimo, long lCuotaX, long lCuotaPS);
    ...
    int iControles, iFlagMovimiento, iSituacionEspecial,
        ...
        iFlagMenuDomiciliacionDeRopa, iFlagMenuDomiciliacionDeMuebles, iFlagCampoInteligentePL, iFlagCertificacionBonidicacion,iFlagTdaConCubrebocas,iFlagETP;
